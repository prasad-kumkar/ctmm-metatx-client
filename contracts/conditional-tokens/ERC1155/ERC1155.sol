 ...
 */
contract ERC1155 is EIP712MetaTransaction, ERC165, IERC1155
{
    ...
    */
        ...
        external
    {
        ...
        require(
            from == msgSender() || _operatorApprovals[from][msgSender()] == true,
        ...
        _doSafeTransferAcceptanceCheck(msgSender(), from, to, id, value, data);
    }
    ...
    */
        ...
        external
    {
        ...
        _doSafeBatchTransferAcceptanceCheck(msgSender(), from, to, ids, values, data);
    }
    ...
    function _mint(address to, uint256 id, uint256 value, bytes memory data) internal {
        ...
        _balances[id][to] = value.add(_balances[id][to]);
        emit TransferSingle(msgSender(), address(0), to, id, value);

        _doSafeTransferAcceptanceCheck(msgSender(), address(0), to, id, value, data);
    }
    ...
    function _batchMint(address to, uint256[] memory ids, uint256[] memory values, bytes memory data) internal {
        ...
        emit TransferBatch(msgSender(), address(0), to, ids, values);

        _doSafeBatchTransferAcceptanceCheck(msgSender(), address(0), to, ids, values, data);
    }
    ...
    function _burn(address owner, uint256 id, uint256 value) internal {
        ...
        emit TransferSingle(msgSender(), owner, address(0), id, value);
    }
    ...
    function _batchBurn(address owner, uint256[] memory ids, uint256[] memory values) internal {
        ...
        emit TransferBatch(msgSender(), owner, address(0), ids, values);
    }
