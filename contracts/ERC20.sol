 ...
 */
contract ERC20 is IERC20, EIP712MetaTransaction {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public returns (bool) {
        ...
        _approve(sender, msgSender(), _allowances[sender][msgSender()].sub(amount));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
        _approve(msgSender(), spender, _allowances[msgSender()][spender].sub(subtractedValue));
        return true;
    }
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(account, msgSender(), _allowances[account][msgSender()].sub(amount));
    }
